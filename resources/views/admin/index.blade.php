...
<div class="d-flex mb-3">
    <a href="{{ route('admin.create') }}" type="button" class="btn btn-success rounded-3 me-2">Tambah Data</a>
    <a href="{{ route('admin.trash') }}" type="button" class="btn btn-secondary rounded-3">Trash</a>
</div>
        ...
        <tr>
            ...
            <td>
                @if(isset($data->chronic_disease))
                    {{ $chronic_diseases[$data->chronic_disease] ?? $data->chronic_disease }}
                @else
                    Tidak ada data
                @endif
            </td>
